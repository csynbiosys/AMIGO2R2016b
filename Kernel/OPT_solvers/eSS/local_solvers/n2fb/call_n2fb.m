...
% frtol = 1.0000e-006;
% 
%       V(31) = fatol;  % absolut function convergence
%       V(32) = frtol;  % relative function convergence
% 
...
v(42) = 0.0046; % V(DLTFDC) Default = MACHEP^1/3. error tolerance in CVODES 1e-7, 1e-7^-3=0.0046
v(43) = 3.1623e-4; %V(DLTFDJ) Default = MACHEP^1/2  error tolerance in CVODES 1e-7  1e-7^-2=3.1623e-4 
