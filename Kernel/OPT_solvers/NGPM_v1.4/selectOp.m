% $Header: svn://.../trunk/AMIGO2R2016/Kernel/OPT_solvers/NGPM_v1.4/selectOp.m 770 2013-08-06 09:41:45Z attila $
...
randnum = randi(popsize, [1, 2 * popsize]); %randint(popsize, popsize, [1, 1 * popsize]); %EBC 

      
    
j = 1;
for i = 1:2:(2*popsize) %2*popsize
    p1 = randnum(i);
    p2 = randnum(i+1);
