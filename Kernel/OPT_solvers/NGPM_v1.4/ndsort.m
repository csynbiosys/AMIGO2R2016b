% $Header: svn://.../trunk/AMIGO2R2016/Kernel/OPT_solvers/NGPM_v1.4/ndsort.m 770 2013-08-06 09:41:45Z attila $
...
for fid = 1:length(front)
    ...
    for ipt = 1:numRefPoint
        [ipt,ix] = sort(normDistance(:, ipt)); %EBC [~,ix] = sort(normDistance(:, ipt));
