function [idx,k_groups,C,sumd,D] = incremental_clustering_correlation(X,r,mode,plot_flag)
...
while stop
    ...
    [idx,C,sumd,D] = kmeans(X,k_groups,'distance','correlation','replicates',n_rep,'emptyaction','singleton','start',M,'Options',opts);%'correlation''city'
