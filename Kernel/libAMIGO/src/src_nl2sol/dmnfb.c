/* dmnfb.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dmnfb_(integer *p, doublereal *d__, doublereal *x, 
	doublereal *b, S_fp calcf, integer *iv, integer *liv, integer *lv, 
	doublereal *v, integer *uiparm, doublereal *urparm, U_fp ufparm)
{
    static integer nf;
    static doublereal fx;
    extern /* Subroutine */ int drmnfb_(doublereal *, doublereal *, 
...
/*     MEANINGS FOR  DMNFB THAN FOR  DMNG... */
...
/* DRMNFB... OVERSEES COMPUTATION OF FINITE-DIFFERENCE GRADIENT AND */
...
/* +++++++++++++++++++++++++++++++  BODY  ++++++++++++++++++++++++++++++++ */
    ...
    /* Function Body */
L10:
    drmnfb_(&b[3], &d__[1], &fx, &iv[1], liv, lv, p, &v[1], &x[1]);
    if (iv[1] > 2) {
	goto L999;
    }
