                ...
                case {'Q_expmax','Q_exp'}
                    ...
                    if inputs.PEsol.n_global_theta>0 || inputs.PEsol.n_global_theta_y0>0
                        for iexp=ini_exp:fin_exp
                            ...
                            ssquare{iexp}=repmat(max_data,inputs.exps.n_obs{iexp},inputs.exps.n_s{iexp});
                ...
                case 'Q_expmean'
                    ...
                    if inputs.PEsol.n_global_theta>0 || inputs.PEsol.n_global_theta_y0>0
                        for iexp=ini_exp:fin_exp
                            ...
                            ssquare{iexp}=repmat(mean_data,inputs.exps.n_obs{iexp},inputs.exps.n_s{iexp});
                ...
                case 'hetero_lin'
                    ...
                    if inputs.PEsol.n_global_theta>0 || inputs.PEsol.n_global_theta_y0>0
                        for iexp=ini_exp:fin_exp
                            ...
                            A=repmat(inputs.PEsol.llk.stddeva{iexp}, [inputs.exps.n_s{iexp},1]);
                            B=repmat(inputs.PEsol.llk.stddevb{iexp}, [inputs.exps.n_s{iexp},1]);
