% $Header: svn://.../trunk/AMIGO2R2016/Kernel/IVP_solvers/sens_analysis_1.1/odezero.m 770 2013-08-06 09:41:45Z attila $
function [tout,yout,iout,vnew,stop] = ...
    odezero(ntrpfun,odefile,v,t,y,tnew,ynew,t0,args,varargin);
...
%   coded in the ODE file.
%   
%   See also ODEFILE, ODE45, ODE23, ODE113, ODE15S, ODE23S.

%   Mark W. Reichelt and Lawrence F. Shampine, 6-13-94
%   Copyright (c) 1984-98 by The MathWorks, Inc.
%   $Revision: 1.19 $  $Date: 1998/05/21 11:08:26 $
...
yL = y;
vL = v;
[vnew,isterminal,direction] = feval(odefile,tnew,ynew,'events',args{:});
...
while 1
  ...
  while 1
    ...
    vtry = feval(odefile,ttry,ytry,'events',args{:});
  ...
  elseif abs(tnew - tR) <= tol
    ...
    vL = feval(odefile,tL,yL,'events',args{:});
