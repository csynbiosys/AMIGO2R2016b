function [out] = Rident1(epcc_exps)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
short_name     = strcat('IndProm',int2str(epcc_exps));    inputs.pathd.results_folder = results_folder;
...
inputs.pathd.short_name     = short_name;
inputs.pathd.runident       = strcat('RIdent-',int2str(epcc_exps));
