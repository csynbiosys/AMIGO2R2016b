%This script specifies the model M, having:
...
model.par_names=char('alpha1','Vm1','h1','Km1','d1','alpha2','d2','Kf','sc_molec');    % Names of the parameters
...
model.par = [0.0164186333380725 0.291556643109224 1.71763487775568 5.14394334860864 0.229999999999978 6.63776658557266 0.00575139649497780 0.0216999999961899 28]; % The parameter vector is set to the best estimates for MIP,r
