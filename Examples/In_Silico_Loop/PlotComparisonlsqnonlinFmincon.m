...
gal1_load_model_v2;
model.par = [5.7505e-12; 1.7290e+00; 1.6275e-01; 7.9925e-03; 9.9190e-01; 9.2000e-03; 1.3250e-01; 8.1406e-03];
% fmincon	
...
sim_resfmincon = AMIGO_SModel(inputs);
close all; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear model;
clear exps;
...
% Read the model into the model variable
gal1_load_model_v2;
model.par = [1.2307e-14; 5.1842e-01; 1.4383e-02; 9.9745e-03; 1.3000e+00; 2.3000e-03; 1.9662e-01; 6.0783e-03];
...
sim_reslsqnon = AMIGO_SModel(inputs);
close all; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;

shadedErrorBar(exps.t_s{1,1},exps.exp_data{1,1},exps.error_data{1,1},'lineprops','k'); hold on; 
plot(sim_resfmincon.sim.tsim{1,1},sim_resfmincon.sim.states{1,1}(:,3), 'c',sim_reslsqnon.sim.tsim{1,1},sim_reslsqnon.sim.states{1,1}(:,3), 'b')%, sim_res{exp}.sim.tsim{1}, sim_res{exp}.sim.states{1}(:,3), 'g');
title(int2str(1));
