...
model.st_names=char('L0','L1','L2','Lac12','Lac12m','G20','G21','G22','IPTGi','Cit_molec');     % Names of the states                                              
model.par_names=char('kLacI','k2','kd','km2','k1','km1',...
                     'kLac12','kTP1',...
                     'kcat','Km','kout',...
                     'kC','lk',...
                     'Scale_molec');           % Names of the parameters                     
...
model.par=[0.005,2.79e-6,7.75e-5,0.012,2.7e-4,0.0049,0.049,5.4e-4,3.57, 2800, 5,0.049,1e-10,27.18];
