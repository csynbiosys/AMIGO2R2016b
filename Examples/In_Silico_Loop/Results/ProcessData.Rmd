---
title: Analysis of 10 x 6 hour experiments with 5 params, 10 input steps, fixed duration, 5 mins for OID, normalised parameters, E optimality
author: "Ally Hume"
...
* Experiment name: Jyn Erso
* Each run executed 10 OID-Experiment-PE loops. 
* Using gal1 no-delay model
* Parameters are normalised so that the true value for all parameters is 1.
...
# Get the data files.
files <- list.files(pattern='EethKoth.*dat')
