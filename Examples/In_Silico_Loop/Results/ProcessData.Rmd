---
title: Analysis of 10 x 6 hour experiments with 5 params, 72 input steps, 5 mins for
  OID
author: "Ally Hume"
...
* Experiment name: Luke Skywalker
...
# Get the data files.
files <- list.files(pattern='LukeSkywalker*dat')
