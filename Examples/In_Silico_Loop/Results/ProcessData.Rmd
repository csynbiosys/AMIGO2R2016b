---
title: Analysis of 10 x 6 hour experiments with 5 params, 10 input steps, variable duration, 5 mins for OID, normalised parameters, D optimality
author: "Ally Hume"
...
# Get the data files.
files <- list.files(pattern='DarthVader.*dat')
