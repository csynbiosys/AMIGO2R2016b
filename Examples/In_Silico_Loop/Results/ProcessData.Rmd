---
title: Analysis of 10 x 6 hour experiments with 5 params, 10 random input steps, fixed duration
author: "Ally Hume"
...
* OID just chooses 10 random step values
...
# Get the data files.
files <- list.files(pattern='JarJar.*dat')
