function [] = run_in_silico_experiment_parfor( resultBase, numLoops, numExperiments )
...
parfor epcc_exps=1:numExperiments
        ...
        try
            ...
            [out] = fit_to_InduciblePromoter_Optimised(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess); % How uses the homovar data (5%)
