...
model.par_names=char('alpha1','h1','Km1','d1',...
...
model.eqns=...                                      % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('Vm1=(d1*Kb*(Kf+d2)/(alpha2*Kf) - alpha1) * (Km1^h1 + 2^h1)/2^h1',...
...
model.par=[0.00175985449291231,2.22548971250921,0.1,0.0100614569676223,1,1,1,1] 
