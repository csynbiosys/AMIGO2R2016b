function [out] = fit_InduciblePromoter_to_Stelling_data_crossvalidation_f(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
...
% remaining being use as a test set 
    ...
    global_theta_min = [6.4667e-7,6.4667e-4,0.5,2,1.2833e-4,0.0041,9.9667e-7,2e-4,10]; %sec
