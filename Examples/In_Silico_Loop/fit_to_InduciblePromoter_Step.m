...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dur = 100;                      % Duration of each step, in min (this value exceeds the response time, quantified in 80 mins)
    numCycles = duration/dur/2;      % Number of low-high cycles
    inducer = randi([0 1000],1,2);  % Extract 2 random integer values in the range of induction (0,1000)uM to be used as low and high values in the step
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    newExps.u{1}=repmat(inducer,1,numCycles);
