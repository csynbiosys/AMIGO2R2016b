...
inputs.exps.obs_names{1}=char('mRNA','Fluorescence');  % Name of the observed quantities per experiment    
inputs.exps.obs{1}=char('mRNA=gal1_mrna','Fluorescence=gal1_fluo'); % Observation function
...
exps.obs_names{iexp}=char('mRNA', 'Fluorescence');  % Name of the observed quantities per experiment    
exps.obs{iexp}=char('mRNA=gal1_mrna','Fluorescence=gal1_fluo'); % Observation function
...
save('multistart_2ObsA_200hours.mat','results');
