...
inputs.exps.obs_names{1}=char('FoldedProtein', 'Fluorescence');  % Name of the observed quantities per experiment    
inputs.exps.obs{1}=char('FoldedProtein=gal1_foldedP', 'Fluorescence=gal1_fluo'); % Observation function
...
exps.obs_names{iexp}=char('FoldedProtein', 'Fluorescence');  % Name of the observed quantities per experiment    
exps.obs{iexp}=char('FoldedProtein=gal1_foldedP', 'Fluorescence=gal1_fluo'); % Observation function
...
save('multistart_2ObsB_200hours.mat','results');
