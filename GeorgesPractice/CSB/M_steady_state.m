function [ res ] = M_steady_state( theta, IPTG )
%M_steady_state Calculates the steady state for theta and
%IPTG
%   Computes the steady state of the M model for the given values of
