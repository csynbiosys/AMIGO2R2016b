...
inputs.pathd.short_name='NOPFL';                    % To identify figures and reports for a given problem 
...
inputs.model.eqns=...                                      % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('dx1=v1*(a1+(1-a1)*K1^(-h1)/(K1^(-h1)+((theta^h2)*13.69/(theta^h2+(2.25*1000)^h2))^(-h1)))-d1*x1',...
                    'dx3=v2*x1-(d3+Kf)*x3',...
                    'dx4=Kf*x3-d3*x4');              
a1=1.13e-5;
v1=7.54e-2;
...
%==================================
 ...
 inputs.exps.exp_y0{1}=1*[7.20114225522094,43.5602288507501,16.6652208775991];                 % Initial conditions for each experiment       
