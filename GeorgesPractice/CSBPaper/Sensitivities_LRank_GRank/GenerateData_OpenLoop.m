...
testIPTG=[0,1e-1,0.5,1,2,5,10,20,50,100,500,1000,5000,1e4];
%testIPTG=IPTG;
...
for i=1:inputs.exps.n_exp
    ...
    steadyAU(i)=steadyAUt(1,2)*inputs.model.par(14)/492;
end
...
semilogx(CitrineW(:,1),CitrineW(:,2),'-o');hold on;
hold on;
...
inputs.model=Model_OpenLoop_BestFitWO_George1();
...
semilogx(CitrineWO(:,1),CitrineWO(:,2),'-o');hold on;
semilogx(testIPTG,CitrineAU,'-o');
