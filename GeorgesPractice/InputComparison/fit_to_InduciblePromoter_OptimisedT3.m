...
for i=1:numLoops
    ...
    inputs.nlpsol.DE.itermax = round((500e3)/inputs.nlpsol.DE.NP);        % maximum number of iterations ('generations')
    ...
    inputs.nlpsol.DE.F = 0.4;                                               % F: DE-stepsize [0,2]
    inputs.nlpsol.DE.CR = 0.3;                                              % CR: crossover probability constant [0,1]
    inputs.nlpsol.DE.strategy =8;
    % strategy
    %                1 --> DE/best/1/exp
    %                2 --> DE/rand/1/exp
