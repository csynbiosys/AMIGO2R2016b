function [cost,designs,curve_time,curve_cost,results]=solveOEDTF...
    (theta_min,theta_max,numSteps,numLoops,global_theta_guess,F,rngSeed,CR,S)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:numLoops
    ...
    inputs.nlpsol.DE.itermax = round((150e3)/inputs.nlpsol.DE.NP);        % maximum number of iterations ('generations')
