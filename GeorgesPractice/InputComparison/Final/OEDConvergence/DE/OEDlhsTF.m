function fullresult = OEDlhsTF(numSteps,numExperiments,numLoops,F,CR,S)
...
rngSeeds=1e8*rand(numExperiments,1);
result=cost;
%warning('off');
...
parfor epcc_exps=1:numExperiments
    [cost{epcc_exps},designs{epcc_exps},...
        ...
        result{epcc_exps}]=solveOEDTF...
        (theta_min,theta_max,numSteps,numLoops,LHS_guess(epcc_exps,:),F,rngSeeds(epcc_exps),CR,S);
end
