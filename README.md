...
* Running 15 x 4-hour experiments rather than 5 x 12 hour experiments
* OID time is now 5 mins 

Full description:
* Each	run	executed	15	loops
...
* The	input	stimulus was	stepped	with	8	steps	(each 30 mins) (values	between	0	and	2)
...
```
git clone <this-repo>
git checkout Experiment-Sabine
cd AMIGO2R2016/Examples/In_Silico_Loop
matlab -nodesktop -nosplash -r "run_in_silico_experiment('Sabine-batch1', 50); quit;"
```

This will run 50 runs and created files starting with "Sabine-batch1"
