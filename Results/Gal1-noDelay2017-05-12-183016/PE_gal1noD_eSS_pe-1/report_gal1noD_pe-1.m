...
Date: 12-May-2017
Problem folder:	 Results\Gal1-noDelay2017-05-12-183016
Results folder in problem folder:	 Results\Gal1-noDelay2017-05-12-183016\PE_gal1noD_eSS_pe-1 
...
ess_options.
	...
	ndiverse:	'auto'
		...
		v_guess(2)=0.006554;  v_min(2)=0.001030; v_max(2)=0.103000;
		v_guess(3)=2.686776;  v_min(3)=0.189070; v_max(3)=5.000000;
		v_guess(4)=0.196204;  v_min(4)=0.003680; v_max(4)=0.368000;
		v_guess(5)=0.016567;  v_min(5)=0.003000; v_max(5)=0.300000;
...
-->Initial conditions for each experiment:
		Experiment 1: 
			exp_y0=[3.614e-03  2.938e-03  3.379e-04  ]
...
-->Input values/temporal elements for Experiment 1:
		step interpolation is being used.
			Control values:
			Input 1:	  0.4324	  1.9401	  1.1817	  1.5164	  0.0053	  0.5644	
...
>>>>    Mean / Maximum value of the residuals in percentage (100*(data-model)/data):
		...
		Experiment 1 : 
		 Observable 1 --> mean error: 75.745737 %	 max error: 2305.846626 %
...
>>>>  Maximum absolute value of the residuals (data-model):
		...
		Experiment 1 : 
		 Observable 1 -->  max residual: 0.007006 max data: 0.029261

--------------------------------------------------------------------------	   

>>>> Best objective function: 0.000688 
