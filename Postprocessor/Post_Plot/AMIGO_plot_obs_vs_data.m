...
for iexp=1:inputs.exps.n_exp
    plot_title={results.plotd.data_plot_title,sprintf('observed vs predicted data (exp:%d )',iexp)};
    %plot_title={results.pathd.short_name,['experiment: ',mat2str(iexp)]};
    n_max_plots=min([inputs.exps.n_obs{iexp} results.plotd.number_max_obs]);
